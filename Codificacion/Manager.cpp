...
//A        Pila<int> pilaCarretas[2];
        ...
        pilaCarretas->anadirAlFinal(new Pila<int>(numeroCarretas));
        cout<<endl<<"\t-Se crearon las pilas de carretas-"<<endl;
...
//A        cout<<endl<<"ultimo elemento pila[0]"<<pilaCarretas->darPrimerElemento()->inspeccionarUltimoElemento()<<endl;
//A        cout<<endl<<"ultimo elemento pila[1]"<<pilaCarretas->darUltimoElemento()->inspeccionarUltimoElemento()<<endl;
        return pilaCarretas;
...
//A            cout<<endl<<"ambas pilas con carretas llenas, se escoge al azar"<<endl;                        
            if((rand()%(2)) == 0){
...
//A            cout<<endl<<"primer pila llena,se desapila carreta"<<endl;
...
//A            cout<<endl<<"segunda pila llena, se desapila carreta"<<endl;
    ...
    void Manager::asignarCarritoCompras(Cola<Cliente> *colaEsperaCarretas, listaEnlazada<Pila<int>> *pilaCarretas, ListaCircular<Cliente> *clientesEnCompras){//recuerda que enviaste un puntero, porque se envia un arreglo, por ello se requiere la dirección del primer elemento...
        while(!colaEsperaCarretas->estaVacia() && (!pilaCarretas->darPrimerElemento()->estaVacia() || !pilaCarretas->darUltimoElemento()->estaVacia())){//pues se requiere que al menos 1 de las dos tengan carretas...
            ...
            cout<<"El cliente ingresa a escoger productos"<<endl;
        }
    ...
    void Manager::enviarColaPago(ListaCircular<Cliente> *clientesEnCompras, Cola<Cliente> *colaDePagos){
        ...
        bool pagoAlMenosUno = false;        

//A        cout<<"#clientes escogiendo productos: "<<clientesEnCompras->darTamanio();
...
//A                cout<<endl<<"se intenta enviar a "<<ubicacionCliente<<" cola de pago"<<endl;
...
//a        cout<<"#clientes escogiendo productos: "<<clientesEnCompras->darTamanio();
        if(!pagoAlMenosUno){//yo esperaria que de el valor corecto xD
            cout<<endl<<"    Ningun cliente se dirigio a cola de pagos"<<endl;            
        }
...
//A                cout<<"el cliente intenta salir de la tienda"<<endl;    
...
//A                cout<<"se intenta añadir cliente a caja"<<endl;    
